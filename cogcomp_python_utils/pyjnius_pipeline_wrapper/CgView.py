        ...
        def getRelations(self,position=None): 
                if(self.viewType!="TreeView"):
                       ...
                       return
                        ...
                        relationArray=[]
                        if position is not None:
                                relationArray.append(self.viewJson["views"][self.viewPos]["viewData"][0]["relations"][position]["relationName"])
                        else:
                                for i in range(0,len(self.viewJson["views"][self.viewPos]["viewData"][0]["relations"])):
                                        relationArray.append(self.viewJson["views"][self.viewPos]["viewData"][0]["relations"][i]["relationName"])
